// ignoreforfile: unnecessaryconst
...
class ColorConstants {
  ...
  static var gradientColorLightPrimary = colorPrimaryLight.withOpacity(0.7);
  static var gradientColorDarkPrimary = colorPrimaryDark.withOpacity(0.7);
